...
public class Helper {
	...
	static List<String> BodyObjectsList = new ArrayList<String>(); 
	
	static List<String> HeadSubjectsList = new ArrayList<String>(); 
	static List<String> HeadPredicatesList = new ArrayList<String>(); 
	static List<String> HeadObjectsList = new ArrayList<String>(); 
    ...
    // Use here the same IRI as your SMW or Surgipedia
  	...
  	public static void buildBody(String rdfexport) throws IOException {
	...
	public static void buildHead(String rdfexport) throws NumberFormatException, IOException {
	...
	public static String addRuleClass (String rulePart, String name, String var)
    {
    ...
    public static String addRuleObjectProperty (String rulePart, String name, String var1, String var2)
    {
    	if ((name != "") && (name != null))
    ...
    public static String addRuleDataStringProperty (String rulePart, String name, String var, String value)
    {
    	if ((name != "") && (name != null))
    ...
    public static String addRuleDataNumberProperty (String rulePart, String name, String var1, String var2)
    {
    	if ((name != "") && (name != null))
        rulePart = rulePart + name + "(?" + var1 + ",?" + var2 + ")^";
		varsBank.add(var2);
