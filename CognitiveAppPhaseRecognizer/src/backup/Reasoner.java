...
public class Reasoner {
    ...
    public Boolean action(String rule, String context, String opType, String outputPath) throws OWLOntologyCreationException, OWLOntologyStorageException, IOException {
