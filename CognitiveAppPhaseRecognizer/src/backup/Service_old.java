	...
	public void postStuff(String rdf, @Context final HttpServletResponse servletResponse, @Context final HttpServletRequest servletRequest, @Context final ServletContext context) throws IOException, SAXException, OWLOntologyCreationException, OWLOntologyStorageException {
		...
		*/
		...
		if (soln==null) 
			...
			opType = soln.getLiteral("opType").toString();
	        ...
	        String querystring2 = ServiceHelper_old.getSparqlPatternForSWRLRuleFile(prefix, ruleName);
			QuerySolution soln2 = ServiceHelper_old.evaluationOfSPARQLQueryAgainstModel(querystring2, model2);
			...
			if (soln2 == null) {
				...
				Reasoner_old reasoner_old = new Reasoner_old();
				reasoner_old.action(swrlRuleFile, phaseContext, opType, outputPath);
			}
		}
	}
